              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header d-block">
                    ...
                    <a href="<?php echo base_url('restrito/master/core') ?>" class="btn btn-primary float-right">Cadastrar</a>
                  </div>
                  <div class="card-body">
                        ...
                        <tbody>
                          <?php foreach($master as $pai): ?>
                            <tr>
                              ...
                              <td>
                                <a href="<?php echo base_url('restrito/master/core/'.$pai->categoria_pai_id); ?>" class="btn btn-primary btn-icon"><i class="far fa-edit"></i></a>
                                <a href="<?php echo base_url('restrito/master/delete/'.$pai->categoria_pai_id); ?>" class="btn btn-icon btn-danger delete" data-confirm="Tem certeza da exclusão?"><i class="fas fa-times"></i></a>
                              </td>
                            </tr>
                          <?php endforeach;  ?>
                        </tbody>
