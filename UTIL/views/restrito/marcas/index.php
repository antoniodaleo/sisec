              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header d-block">
                    ...
                    <a href="<?php echo base_url('restrito/marcas/core') ?>" class="btn btn-primary float-right">Cadastrar</a>
                  </div>
                  <div class="card-body">
                        ...
                        <tbody>
                          <?php foreach($marcas as $marca): ?>
                            <tr>
                              ...
                              <td>
                                <a href="<?php echo base_url('restrito/marcas/core/'.$marca->marca_id); ?>" class="btn btn-primary btn-icon"><i class="far fa-edit"></i></a>
                                <a href="<?php echo base_url('restrito/marcas/delete/'.$marca->marca_id); ?>" class="btn btn-icon btn-danger delete" data-confirm="Tem certeza da exclusão?"><i class="fas fa-times"></i></a>
                              </td>
                            </tr>
                          <?php endforeach;  ?>
                        </tbody>
