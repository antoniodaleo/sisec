              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header d-block">
                    ...
                    <a href="<?php echo base_url('restrito/usuario/core') ?>" class="btn btn-primary float-right">Cadastrar</a>
                  </div>
                  <div class="card-body">
                        ...
                        <tbody>
                          <?php foreach($usuarios as $usuario): ?>
                            <tr>
                              ...
                              <td>
                                <a href="<?php echo base_url('restrito/usuario/core/'.$usuario->id); ?>" class="btn btn-primary btn-icon"><i class="far fa-edit"></i></a>
                                <a href="<?php echo base_url('restrito/usuario/delete/'.$usuario->id); ?>" class="btn btn-icon btn-danger delete" data-confirm="Tem certeza da exclusão?"><i class="fas fa-times"></i></a>
                              </td>
                            </tr>
                          <?php endforeach;  ?>
                        </tbody>
