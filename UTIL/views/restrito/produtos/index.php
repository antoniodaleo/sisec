              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header d-block">
                    ...
                    <a href="<?php echo base_url('restrito/produtos/core') ?>" class="btn btn-primary float-right">Cadastrar</a>
                  </div>
                  <div class="card-body">
                        ...
                        <tbody>
                          <?php foreach($produtos as $produto): ?>
                            <tr>
                              ...
                              <td>
                                <a href="<?php echo base_url('restrito/produtos/core/'.$produto->produto_id); ?>" class="btn btn-primary btn-icon"><i class="far fa-edit"></i></a>
                                <a href="<?php echo base_url('restrito/produtos/delete/'.$produto->produto_id); ?>" class="btn btn-icon btn-danger delete" data-confirm="Tem certeza da exclusão?"><i class="fas fa-times"></i></a>
                              </td>
                            </tr>
                          <?php endforeach;  ?>
                        </tbody>
