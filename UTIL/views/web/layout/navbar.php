                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="header-top-left">
                                    <ul class="phone-wrap">
                                        ...
                                        <li><span>Nosso telefone:</span><?php echo $sistema->sistema_telefone_fixo ?></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="logo pb-sm-30 pb-xs-30">
                                    <a href="index.html">
                                        <img src="<?php echo base_url('assets/web/images/menu/logo/1.jpg') ?>" alt="">
                                    </a>
                                </div>
                            </div>
