        ...
        <!-- jQuery-V1.12.4 -->
        <script src="<?php echo base_url('assets/web/js/vendor/jquery-1.12.4.min.js')  ?> "></script>
        <!-- Popper js -->
        <script src="<?php echo base_url('assets/web/js/vendor/popper.min.js') ?>"></script>
        <!-- Bootstrap V4.1.3 Fremwork js -->
        <script src="<?php echo base_url('assets/web/js/bootstrap.min.js') ?>"></script>
        <!-- Ajax Mail js -->
        <script src="<?php echo base_url('assets/web/js/ajax-mail.js') ?>"></script>
        <!-- Meanmenu js -->
        <script src="<?php echo base_url('assets/web/js/jquery.meanmenu.min.js') ?>"></script>
        <!-- Wow.min js -->
        ...
        <!-- Mixitup js -->
        <script src="<?php echo base_url('assets/web/js/jquery.mixitup.min.js') ?>"></script>
        <!-- Countdown -->
        ...
        <!-- Barrating -->
        <script src="<?php echo base_url('assets/web/js/jquery.barrating.min.js') ?>"></script>
        <!-- Jquery-ui -->
        <script src="<?php echo base_url('assets/web/js/jquery-ui.min.js') ?>"></script>
        <!-- Venobox -->
        <script src="<?php echo base_url('assets/web/js/venobox.min.js') ?>"></script>
        <!-- Nice Select js -->
