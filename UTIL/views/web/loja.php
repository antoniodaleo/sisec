                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 text-center pt-xs-30">
                            <div class="li-banner">
                                <a href="#">
                                    <img src="<?php echo base_url('assets/web/images/banner/1_1.jpg') ?>" alt="">
                                </a>
                            </div>
                            <div class="li-banner mt-15 mt-sm-30 mt-xs-30">
                                <a href="#">
                                    <img src="<?php echo base_url('assets/web/images/banner/1_2.jpg') ?>" alt="">
                                </a>
                            </div>
                        </div>
                                        ...
                                        <div class="single-product-wrap">
                                            ...
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    ...
                                                    <h4><a class="product_name" href="single-product.html"><?php echo word_limiter($pro->produto_nome, 4) ; ?></a></h4>
                                                    <div class="price-box">
                                                ...
                                                <div class="add-actions">
                                                    <ul class="add-actions-link">
                                                        <li class="add-cart active"><a href="<?php echo base_url('produto/'.$pro->produto_meta_link); ?>">Adiciona</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-product-wrap">
                                            ...
                                            <div class="product_desc">
                                                ...
                                                <div class="add-actions">
                                                    <ul class="add-actions-link">
                                                        <li class="add-cart active"><a href="">Visualizar</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="product-active owl-carousel">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="<?php echo base_url('assets/web/images/product/large-size/3.jpg') ?>" alt="Li's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                            </div>
                                            <div class="product_desc">
