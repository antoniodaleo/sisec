            ...
            <div class="col-lg-7 col-md-6">
                <div class="product-details-view-content pt-60">
                    <div class="product-info">
                        ...
                        <p class="mt-10">
                            <span class="product-details-ref">Marca : <a href="<?php echo base_url('marca/'.$produto->marca_meta_link); ?>"><?php echo $produto->marca_nome ; ?></a> </span>
                        </p>

                        <p class="mt-10">
                            <span class="product-details-ref">Estoque : &nbsp; <?php echo ($produto->produto_quantidade_estoque >0 ? '<span class="badge badge-success "  style="font-size=14px" >'.$produto->produto_quantidade_estoque.'</span>' : '<span class="badge badge-danger" >Indisponivel</span>'); ?> </span>
                        </p>
                        ...
                        <div class="single-add-to-cart">
                            ...
                            <?php echo form_open('ajax', $atributos); ?>
                                ...
                                <button  type="button" name="produto_id" id="btn-calcula-frete" data-id="<?php echo $produto->produto_id; ?>" class="add-to-cart bg-info" style="padding: 12px 20px;">Calcular</button>
